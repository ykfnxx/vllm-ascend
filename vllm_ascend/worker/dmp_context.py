...
class DMPContext:
    ...
    def enter_microbatch(self, idx: int):
        ...
        prev_padded_num_tokens = getattr(forward_context,
    ...
    def slice_hidden_states(self, hidden_states: torch.Tensor,
                            idx: int) -> torch.Tensor:
        s = self.slices[idx]
        return hidden_states[s.start:s.end]

    def merge_hidden_states(self, hs_a: torch.Tensor, hs_b: torch.Tensor,
