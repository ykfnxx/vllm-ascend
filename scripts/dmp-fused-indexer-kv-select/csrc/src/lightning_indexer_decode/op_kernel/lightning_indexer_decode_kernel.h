...
#ifndef lightning_indexer_decode_KERNEL_H
#define lightning_indexer_decode_KERNEL_H
...
#include "lightning_indexer_decode_service_vector.h"
#include "lightning_indexer_decode_service_cube.h"
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *weights,
                                ...
                                const LIDecodeTilingData *__restrict tiling, TPipe *tPipe);
                                            ...
                                            const LIDecodeTilingData *__restrict tiling, TPipe *tPipe)
{
    ...
    if ASCEND_IS_AIV {
        ...
        vectorService.InitVec1GlobalTensor(mm1ResGm, weightsGm, indiceOutGm);
    } else {
...
#endif // lightning_indexer_decode_KERNEL_H
