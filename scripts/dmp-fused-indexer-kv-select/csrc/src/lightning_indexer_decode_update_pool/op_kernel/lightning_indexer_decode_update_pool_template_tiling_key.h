...
#ifndef TEMPLATE_TILING_KEY_LI_DECODE_UPDATE_POOL_H_
#define TEMPLATE_TILING_KEY_LI_DECODE_UPDATE_POOL_H_
...
ASCENDC_TPL_ARGS_DECL(LightningIndexerDecodeUpdatePool,
