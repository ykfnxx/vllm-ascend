...
/*!
 * \file lightning_indexer_decode_update_pool_vector.h
 * \brief
 */
#ifndef lightning_indexer_decode_update_pool_VECTOR_H
#define lightning_indexer_decode_update_pool_VECTOR_H
...
#endif // lightning_indexer_decode_update_pool_VECTOR_H
