...
#ifndef lightning_indexer_decode_update_pool_KERNEL_H
#define lightning_indexer_decode_update_pool_KERNEL_H
...
#include "lightning_indexer_decode_update_pool_service_vector.h"
#include "lightning_indexer_decode_update_pool_service_cube.h"
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *weights,
                                ...
                                __gm__ uint8_t *workspace, const LIUpdatePoolTilingData *__restrict tiling,
                                TPipe *tPipe);
...
__aicore__ inline void LIPreload<LIT>::ProcessMain()
{
    ...
    for (uint32_t requestOffset = 0; requestOffset < requestCount; ++requestOffset) {
        ...
        if (actualSeqLen == 0 || actualSeqLen > constInfo.kSeqSize ||
            actualSeqLen > LICommon::ConstInfo::CACHE_SLOTS_SIZE) {
...
#endif // lightning_indexer_decode_update_pool_KERNEL_H
