...
/*!
 * \file lightning_indexer_decode_update_pool_common.h
 * \brief
 */
#ifndef lightning_indexer_decode_update_pool_COMMON_H
#define lightning_indexer_decode_update_pool_COMMON_H
...
struct ConstInfo {
    ...
    static constexpr uint32_t CACHE_SLOTS_SIZE = 262144;
...
#endif // lightning_indexer_decode_update_pool_COMMON_H
