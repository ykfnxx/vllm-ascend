...
static ge::graphStatus InferShapeLightningIndexerDecodeUpdatePool(gert::InferShapeContext *context)
{
    OPS_ERR_IF(context == nullptr, OPS_LOG_E("LightningIndexerDecodeUpdatePool", "InferShapeContext is nullptr."),
...
static ge::graphStatus InferDataTypeLightningIndexerDecodeUpdatePool(gert::InferDataTypeContext *context)
{
    OPS_ERR_IF(context == nullptr, OPS_LOG_E("LightningIndexerDecodeUpdatePool", "InferDataTypeContext is nullptr."),
               return ge::GRAPH_FAILED);
...
IMPL_OP_INFERSHAPE(LightningIndexerDecodeUpdatePool)
    .InferShape(InferShapeLightningIndexerDecodeUpdatePool)
    .InferDataType(InferDataTypeLightningIndexerDecodeUpdatePool);
} // namespace ops
