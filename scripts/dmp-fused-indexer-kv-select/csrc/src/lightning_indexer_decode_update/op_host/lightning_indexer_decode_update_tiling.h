...
#ifndef lightning_indexer_decode_update_TILING_H_
#define lightning_indexer_decode_update_TILING_H_
...
BEGIN_TILING_DATA_DEF(LIUpdateTilingData)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(LightningIndexerDecodeUpdate, LIUpdateTilingData)

struct LIUpdateCompileInfo {};

struct LIUpdateParaInfo {
...
class LIUpdateTilingInfo {
public:
    const char *opName = nullptr;
    fe::PlatFormInfos *platformInfo = nullptr;
    platform_ascendc::SocVersion socVersion = platform_ascendc::SocVersion::ASCEND910B;
    LIUpdateParaInfo opParamInfo;
...
class LightningIndexerDecodeUpdateTiling {
public:
    explicit LightningIndexerDecodeUpdateTiling(gert::TilingContext *context) : context_(context) {};
    ge::graphStatus ParseAndCheck(LIUpdateTilingInfo &tilingInfo);
    ge::graphStatus DoTiling(LIUpdateTilingInfo *tilingInfo);

private:
    ge::graphStatus GetNpuInfo(LIUpdateTilingInfo &tilingInfo) const;
    ge::graphStatus GetTensorInfo(LIUpdateTilingInfo &tilingInfo) const;
    ge::graphStatus CheckDtype(const LIUpdateTilingInfo &tilingInfo) const;
    ge::graphStatus CheckShape(LIUpdateTilingInfo &tilingInfo) const;

    gert::TilingContext *context_ = nullptr;
    LIUpdateTilingData tilingData_;
};

} // namespace optiling
#endif // lightning_indexer_decode_update_TILING_H_
