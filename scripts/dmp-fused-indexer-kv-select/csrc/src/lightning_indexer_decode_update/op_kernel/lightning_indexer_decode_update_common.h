...
/*!
 * \file lightning_indexer_decode_update_common.h
 * \brief
 */
#ifndef lightning_indexer_decode_update_COMMON_H
#define lightning_indexer_decode_update_COMMON_H
...
#endif // lightning_indexer_decode_update_COMMON_H
