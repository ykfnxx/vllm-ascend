...
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor> asu_hbm_index_lookup(
    at::Tensor& index,
    ...
    int64_t req_num)
{
    ...
    TORCH_CHECK(needs_refill.scalar_type() == at::kBool, "needs_refill must be bool");
    ...
    at::Tensor hit_sparse_indices = at::empty_like(query_index);
    at::Tensor miss_sparse_indices = at::empty_like(query_index);
    at::Tensor resident_token_ids = at::empty(
        {req_num, 10 * 1024}, query_index.options());
    ...
    return std::make_tuple(
        slot_out, miss_out, hit_sparse_indices, miss_sparse_indices, resident_token_ids);
}
