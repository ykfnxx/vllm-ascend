...
#ifndef ACL_HIFLOAT8
#define ACL_HIFLOAT8 ((aclDataType)34)
#define ACL_FLOAT8_E5M2 ((aclDataType)35)
#define ACL_FLOAT8_E4M3FN ((aclDataType)36)
#define ACL_FLOAT8_E8M0 ((aclDataType)37)
#define ACL_FLOAT6_E3M2 ((aclDataType)38)
#define ACL_FLOAT6_E2M3 ((aclDataType)39)
#define ACL_FLOAT4_E2M1 ((aclDataType)40)
#define ACL_FLOAT4_E1M2 ((aclDataType)41)
#endif
...
#define EXEC_NPU_CMD_V1(aclnn_api, ...)                                                                                \
    do {                                                                                                               \
        ...
        TORCH_CHECK(workspace_status == 0,                                                                              \
                    "call " #aclnn_api "GetWorkspaceSize failed, status:", workspace_status,                          \
        ...
        auto acl_call = [converted_params, workspace_addr, workspace_size, acl_stream, executor, workspace_tensor]     \
                            ()->int {                                                                                   \
            ...
            TORCH_CHECK(api_ret == 0, "call " #aclnn_api " execute failed, status:", api_ret,                        \
                        ", detail:", aclGetRecentErrMsg());                                                           \
