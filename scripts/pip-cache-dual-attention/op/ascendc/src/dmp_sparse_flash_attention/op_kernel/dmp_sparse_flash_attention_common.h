...
/*!
 * \file dmp_sparse_flash_attention_common.h
 * \brief
 */

#ifndef DMP_SPARSE_FLASH_ATTENTION_COMMON_H
#define DMP_SPARSE_FLASH_ATTENTION_COMMON_H
...
struct ConstInfo {
    ...
    // Dual-Attention LSE export / prior state (user GM, optional)
    bool daExportLse = false;
    bool daPriorLse = false;
    bool daPriorAttentionOut = false;
};
...
#endif // DMP_SPARSE_FLASH_ATTENTION_COMMON_H