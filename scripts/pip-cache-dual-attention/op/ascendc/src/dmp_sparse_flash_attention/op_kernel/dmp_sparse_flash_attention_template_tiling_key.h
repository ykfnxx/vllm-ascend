...
/*!
 * \file dmp_sparse_flash_attention_template_tiling_key.h
 * \brief
 */

#ifndef DMP_SPARSE_FLASH_ATTENTION_TEMPLATE_TILING_KEY_H
#define DMP_SPARSE_FLASH_ATTENTION_TEMPLATE_TILING_KEY_H
...
// 模板参数支持的范围定义
ASCENDC_TPL_ARGS_DECL(DmpSparseFlashAttention, // 算子OpType
