...
/*!
 * \file dmp_sparse_flash_attention_service_cube_mla.h
 * \brief use 7 buffer for matmul l1, better pipeline
 */
#ifndef DMP_SPARSE_FLASH_ATTENTION_SERVICE_CUBE_MLA_H
#define DMP_SPARSE_FLASH_ATTENTION_SERVICE_CUBE_MLA_H
...
#endif // DMP_SPARSE_FLASH_ATTENTION_SERVICE_CUBE_MLA_H