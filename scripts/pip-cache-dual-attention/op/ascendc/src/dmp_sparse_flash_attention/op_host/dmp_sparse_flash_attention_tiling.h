...
/*!
 * \file dmp_sparse_flash_attention_tiling.h
 * \brief
 */
#ifndef DMP_SPARSE_FLASH_ATTENTION_TILING_H
#define DMP_SPARSE_FLASH_ATTENTION_TILING_H
...
constexpr uint32_t SOFTMAX_MAX_OUT_INPUT_INDEX = 9;
constexpr uint32_t SOFTMAX_SUM_OUT_INPUT_INDEX = 10;
constexpr uint32_t PRIOR_SOFTMAX_MAX_INPUT_INDEX = 11;
constexpr uint32_t PRIOR_SOFTMAX_SUM_INPUT_INDEX = 12;
constexpr uint32_t PRIOR_ATTENTION_OUT_INPUT_INDEX = 13;
// Outputs Index
...
struct SFAParaInfo {
    ...
    SFAOptionalParaInfo softmaxMaxOut = {nullptr, nullptr};
    SFAOptionalParaInfo softmaxSumOut = {nullptr, nullptr};
    SFAOptionalParaInfo priorSoftmaxMax = {nullptr, nullptr};
    SFAOptionalParaInfo priorSoftmaxSum = {nullptr, nullptr};
    SFAOptionalParaInfo priorAttentionOut = {nullptr, nullptr};
...
// -----------算子TilingData定义---------------
BEGIN_TILING_DATA_DEF(DmpSparseFlashAttentionBaseParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(DmpSparseFlashAttentionBaseParamsMlaOp, DmpSparseFlashAttentionBaseParamsMla)

BEGIN_TILING_DATA_DEF(DmpSparseFlashAttentionSingleCoreParamsMla)
TILING_DATA_FIELD_DEF(uint32_t, usedCoreNum);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(DmpSparseFlashAttentionSingleCoreParamsMlaOp, DmpSparseFlashAttentionSingleCoreParamsMla)

BEGIN_TILING_DATA_DEF(DmpSparseFlashAttentionSingleCoreTensorSizeMla)
TILING_DATA_FIELD_DEF(uint32_t, mmResUbSize);
TILING_DATA_FIELD_DEF(uint32_t, bmm2ResUbSize);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(DmpSparseFlashAttentionSingleCoreTensorSizeMlaOp, DmpSparseFlashAttentionSingleCoreTensorSizeMla)

BEGIN_TILING_DATA_DEF(DmpSparseFlashAttentionSplitKVParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(DmpSparseFlashAttentionSplitKVParamsMlaOp, DmpSparseFlashAttentionSplitKVParamsMla)

// 内切基本块参数
BEGIN_TILING_DATA_DEF(DmpSparseFlashAttentionInnerSplitParams)
TILING_DATA_FIELD_DEF(uint32_t, mBaseSize)
TILING_DATA_FIELD_DEF(uint32_t, s2BaseSize)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(DmpSparseFlashAttentionInnerSplitParamsOp, DmpSparseFlashAttentionInnerSplitParams)

BEGIN_TILING_DATA_DEF(DmpSparseFlashAttentionTilingDataMla)
TILING_DATA_FIELD_DEF_STRUCT(DmpSparseFlashAttentionBaseParamsMla, baseParams);
TILING_DATA_FIELD_DEF_STRUCT(DmpSparseFlashAttentionSplitKVParamsMla, splitKVParams);
TILING_DATA_FIELD_DEF_STRUCT(DmpSparseFlashAttentionSingleCoreParamsMla, singleCoreParams);
TILING_DATA_FIELD_DEF_STRUCT(DmpSparseFlashAttentionSingleCoreTensorSizeMla, singleCoreTensorSize);
TILING_DATA_FIELD_DEF_STRUCT(DmpSparseFlashAttentionInnerSplitParams, innerSplitParams);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(DmpSparseFlashAttention, DmpSparseFlashAttentionTilingDataMla)
...
private:
    ...
    DmpSparseFlashAttentionTilingDataMla tilingData_;
...
#endif // DMP_SPARSE_FLASH_ATTENTION_TILING_H
