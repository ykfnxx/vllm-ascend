...
ge::graphStatus CopyInputShapeToOutput(
...
static ge::graphStatus InferShapeAsuHbmIndexMaintainAicpu(
    gert::InferShapeContext* context)
{
    OPS_ERR_IF(
        context == nullptr,
    ...
    for (uint32_t i = 0; i < STATE_OUTPUT_COUNT; ++i) {
        if (CopyInputShapeToOutput(context, i, i) !=
            ge::GRAPH_SUCCESS) {
            return ge::GRAPH_FAILED;
        }
    }
...
static ge::graphStatus InferDataTypeAsuHbmIndexMaintainAicpu(
