...
class DsaSparseTurboLookupUpdateBatch : public OpDef {
public:
    explicit DsaSparseTurboLookupUpdateBatch(const char* name) : OpDef(name)
    {
...
OP_ADD(DsaSparseTurboLookupUpdateBatch);
