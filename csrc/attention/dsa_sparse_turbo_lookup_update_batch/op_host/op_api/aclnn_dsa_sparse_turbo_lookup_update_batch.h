...
#ifndef ACLNN_DSA_SPARSE_LOOKUP_UPDATE_TURBO_H
#define ACLNN_DSA_SPARSE_LOOKUP_UPDATE_TURBO_H
...
aclnnDsaSparseTurboLookupUpdateBatchGetWorkspaceSize(
...
#endif  // ACLNN_DSA_SPARSE_LOOKUP_UPDATE_TURBO_H
