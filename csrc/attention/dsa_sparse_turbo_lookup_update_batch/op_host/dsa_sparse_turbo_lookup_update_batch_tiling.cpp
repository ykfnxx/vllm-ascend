...
#include "dsa_sparse_turbo_lookup_update_batch_tiling.h"
...
static ge::graphStatus DsaSparseTurboLookupUpdateBatchTilingFunc(
    gert::TilingContext* context)
{
    if (context == nullptr) {
    ...
    auto* tiling_data =
        context->GetTilingData<DsaSparseTurboLookupUpdateBatchTilingData>();
...
static ge::graphStatus TilingParseForDsaSparseTurboLookupUpdateBatch(
...
IMPL_OP_OPTILING(DsaSparseTurboLookupUpdateBatch)
    .Tiling(DsaSparseTurboLookupUpdateBatchTilingFunc)
    .TilingParse<DsaSparseTurboLookupUpdateBatchCompileInfo>(
        TilingParseForDsaSparseTurboLookupUpdateBatch);
