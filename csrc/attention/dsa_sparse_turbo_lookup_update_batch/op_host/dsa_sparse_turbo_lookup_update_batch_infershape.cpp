...
static ge::graphStatus InferShapeForDsaSparseTurboLookupUpdateBatch(
...
static ge::graphStatus InferDataTypeForDsaSparseTurboLookupUpdateBatch(
...
IMPL_OP_INFERSHAPE(DsaSparseTurboLookupUpdateBatch)
    .InferShape(InferShapeForDsaSparseTurboLookupUpdateBatch)
    .InferDataType(InferDataTypeForDsaSparseTurboLookupUpdateBatch);
