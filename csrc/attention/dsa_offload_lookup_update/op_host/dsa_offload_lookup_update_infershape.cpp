...
static ge::graphStatus InferShapeForDsaOffloadLookupUpdate(
...
static ge::graphStatus InferDataTypeForDsaOffloadLookupUpdate(
...
IMPL_OP_INFERSHAPE(DsaOffloadLookupUpdate)
    .InferShape(InferShapeForDsaOffloadLookupUpdate)
    .InferDataType(InferDataTypeForDsaOffloadLookupUpdate);
