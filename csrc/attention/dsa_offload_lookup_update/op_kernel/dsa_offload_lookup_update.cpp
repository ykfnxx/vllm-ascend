...
#include "arch35/dsa_offload_lookup_update_simt.h"
#include "dsa_offload_lookup_update_common.h"

extern "C" __global__ __aicore__ void dsa_offload_lookup_update(
    GM_ADDR index,
    ...
    GM_ADDR tiling)
{
    ...
    REGISTER_TILING_DEFAULT(DsaOffloadLookupUpdateTilingData);
    GET_TILING_DATA_WITH_STRUCT(
        DsaOffloadLookupUpdateTilingData,
        tiling_data,
        tiling);
    ...
    asc_vf_call<
        DsaOffloadLookupUpdate::DsaOffloadLookupUpdateSimt>(
