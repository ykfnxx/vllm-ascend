...
#ifndef DSA_SPARSE_LOOKUP_UPDATE_TURBO_FUSED_PREFETCH_TORCH_ADPT_H
#define DSA_SPARSE_LOOKUP_UPDATE_TURBO_FUSED_PREFETCH_TORCH_ADPT_H
    ...
    int64_t block_size)
{
    ...
    EXEC_NPU_CMD(
        ...
        destination_slots,
        miss_mask);
    return std::make_tuple(destination_slots, miss_mask);
}

}  // namespace vllm_ascend

#endif  // DSA_SPARSE_LOOKUP_UPDATE_TURBO_FUSED_PREFETCH_TORCH_ADPT_H
