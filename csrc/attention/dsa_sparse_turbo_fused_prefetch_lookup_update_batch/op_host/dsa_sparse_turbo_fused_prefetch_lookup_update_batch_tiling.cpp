...
#include "dsa_sparse_turbo_fused_prefetch_lookup_update_batch_tiling.h"
...
static ge::graphStatus DsaSparseTurboFusedPrefetchLookupUpdateBatchTilingFunc(
    gert::TilingContext* context)
{
    if (context == nullptr) {
    ...
    if (!GetInputOneDim(
        ...
        !RequireOutputShape(
            context, kDestinationSlotsOut, "destinationSlots",
    ...
    auto* tiling_data =
        context->GetTilingData<DsaSparseTurboFusedPrefetchLookupUpdateBatchTilingData>();
...
static ge::graphStatus TilingParseForDsaSparseTurboFusedPrefetchLookupUpdateBatch(
...
IMPL_OP_OPTILING(DsaSparseTurboFusedPrefetchLookupUpdateBatch)
    .Tiling(DsaSparseTurboFusedPrefetchLookupUpdateBatchTilingFunc)
    .TilingParse<DsaSparseTurboFusedPrefetchLookupUpdateBatchCompileInfo>(
        TilingParseForDsaSparseTurboFusedPrefetchLookupUpdateBatch);
