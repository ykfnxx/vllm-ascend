#!/usr/bin/env python3
"""msprof-based batch vs turbo A5 comparison over the CSV cases.
...
OP_BATCH = "DsaSparseTurboPrefetchLookupUpdateBatch"
OP_TURBO = "DsaSparseTurboFusedPrefetchLookupUpdateBatch"
