...
#ifndef ACLNN_DSA_SPARSE_LOOKUP_UPDATE_BATCH_H
#define ACLNN_DSA_SPARSE_LOOKUP_UPDATE_BATCH_H
...
aclnnDsaSparseLookupUpdateBatchGetWorkspaceSize(
...
#endif  // ACLNN_DSA_SPARSE_LOOKUP_UPDATE_BATCH_H
