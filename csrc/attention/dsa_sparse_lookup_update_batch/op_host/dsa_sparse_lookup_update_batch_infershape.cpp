...
static ge::graphStatus InferShapeForDsaSparseLookupUpdateBatch(
...
static ge::graphStatus InferDataTypeForDsaSparseLookupUpdateBatch(
...
IMPL_OP_INFERSHAPE(DsaSparseLookupUpdateBatch)
    .InferShape(InferShapeForDsaSparseLookupUpdateBatch)
    .InferDataType(InferDataTypeForDsaSparseLookupUpdateBatch);
