...
#ifndef DSA_OFFLOAD_LOOKUP_UPDATE_BATCH_TORCH_ADPT_H
#define DSA_OFFLOAD_LOOKUP_UPDATE_BATCH_TORCH_ADPT_H

namespace vllm_ascend {

inline std::tuple<at::Tensor, at::Tensor> dsa_offload_lookup_update_batch(
    at::Tensor& index,
    ...
    int64_t decode_mode)
{
    ...
    TORCH_CHECK(index.is_contiguous() &&
                ...
                "all dsa_offload_lookup_update_batch tensors must be contiguous");
    ...
    TORCH_CHECK(slot_to_index.device() == device &&
                ...
                "all dsa_offload_lookup_update_batch tensors must be on one device");
...
#endif  // DSA_OFFLOAD_LOOKUP_UPDATE_BATCH_TORCH_ADPT_H
