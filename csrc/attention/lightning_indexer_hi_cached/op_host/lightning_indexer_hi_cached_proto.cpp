...
static ge::graphStatus InferShapeLightningIndexerHiCached(gert::InferShapeContext *context)
{
...
static ge::graphStatus InferDataTypeLightningIndexerHiCached(gert::InferDataTypeContext *context)
{
...
IMPL_OP_INFERSHAPE(LightningIndexerHiCached)
    .InferShape(InferShapeLightningIndexerHiCached)
    .InferDataType(InferDataTypeLightningIndexerHiCached);
} // namespace ops
