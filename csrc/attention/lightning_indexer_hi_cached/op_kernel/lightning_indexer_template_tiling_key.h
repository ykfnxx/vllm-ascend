...
#ifndef TEMPLATE_TILING_KEY_LIGHTNING_INDEXER_HI_CACHED_H_
#define TEMPLATE_TILING_KEY_LIGHTNING_INDEXER_HI_CACHED_H_
...
ASCENDC_TPL_ARGS_DECL(LightningIndexerHiCached,
