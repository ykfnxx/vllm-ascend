...
#define SFA_OP_IMPL(templateClass, tilingdataClass, ...)                                          \
    do {                                                                                          \
        ...
        op.InitDsaSources(key, keyRope, blocktable, hostKey, hostKeyRope, hostBlockTable,          \
                          queryPoolEntries, hotSourceRows, routePlan, installStagingKey,           \
                          installStagingRope);                                                     \
        op.Process();                                                                             \
    } while (0)
#else
...
fused_kv_gather_sparse_flash_attention(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                       ...
                       __gm__ uint8_t* hostKey, __gm__ uint8_t* hostKeyRope,
                       __gm__ uint8_t* hostBlockTable, __gm__ uint8_t* queryPoolEntries,
                       __gm__ uint8_t* hotSourceRows, __gm__ uint8_t* routePlan,
                       __gm__ uint8_t* installStagingKey, __gm__ uint8_t* installStagingRope,
