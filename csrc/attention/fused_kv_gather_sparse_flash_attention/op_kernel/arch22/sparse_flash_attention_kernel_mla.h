...
public:
    ...
    {
        if ASCEND_IS_AIV {
            vectorService.InitDsaSources(hotKey, hotKeyRope, hotBlockTable, hostKey,
                                         hostKeyRope, hostBlockTable, queryPoolEntries,
                                         hotSourceRows, routePlan, installStagingKey,
                                         installStagingRope);
        }
    }
