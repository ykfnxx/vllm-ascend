...
ge::graphStatus InferShapeFusedKvGatherSparseFlashAttention(gert::InferShapeContext *context)
{
...
ge::graphStatus InferDataTypeFusedKvGatherSparseFlashAttention(gert::InferDataTypeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE("SparseFlashAttention", "InferShapeContext is nullptr"),
               return ge::GRAPH_FAILED);
...
IMPL_OP_INFERSHAPE(FusedKvGatherSparseFlashAttention)
    .InferShape(InferShapeFusedKvGatherSparseFlashAttention)
    .InferDataType(InferDataTypeFusedKvGatherSparseFlashAttention);
} // namespace ops
