...
#include "aclnn_fused_kv_gather_sparse_flash_attention.h"
...
extern aclnnStatus aclnnInnerFusedKvGatherSparseFlashAttentionGetWorkspaceSize(
    ...
    const aclTensor *hostKey, const aclTensor *hostKeyRope, const aclTensor *hostBlockTable,
    const aclTensor *queryPoolEntries, const aclTensor *hotSourceRows, const aclTensor *routePlan,
    const aclTensor *installStagingKey, const aclTensor *installStagingRope,
    double scaleValue,
...
extern aclnnStatus aclnnInnerFusedKvGatherSparseFlashAttention(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
...
aclnnStatus aclnnFusedKvGatherSparseFlashAttentionGetWorkspaceSize(
    ...
    aclOpExecutor **executor)
{
    ...
    return aclnnInnerFusedKvGatherSparseFlashAttentionGetWorkspaceSize(
        ...
        hostKey, hostKeyRope, hostBlockTable, queryPoolEntries, hotSourceRows, routePlan,
        installStagingKey, installStagingRope,
...
aclnnStatus aclnnFusedKvGatherSparseFlashAttention(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                     const aclrtStream stream)
{
    return aclnnInnerFusedKvGatherSparseFlashAttention(workspace, workspaceSize, executor, stream);
}
