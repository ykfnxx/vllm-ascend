 ...
 * \brief
 */
#ifndef FUSED_KV_GATHER_SPARSE_FLASH_ATTENTION_TILING_H
#define FUSED_KV_GATHER_SPARSE_FLASH_ATTENTION_TILING_H
...
constexpr uint32_t HOST_KEY_INPUT_INDEX = 9;
constexpr uint32_t HOST_KEY_ROPE_INPUT_INDEX = 10;
constexpr uint32_t HOST_BLOCK_TABLE_INPUT_INDEX = 11;
constexpr uint32_t QUERY_POOL_ENTRIES_INPUT_INDEX = 12;
constexpr uint32_t HOT_SOURCE_ROWS_INPUT_INDEX = 13;
constexpr uint32_t ROUTE_PLAN_INPUT_INDEX = 14;
constexpr uint32_t INSTALL_STAGING_KEY_INPUT_INDEX = 15;
constexpr uint32_t INSTALL_STAGING_ROPE_INPUT_INDEX = 16;
// Outputs Index
...
TILING_DATA_FIELD_DEF(uint32_t, dsaRouteWidth)
TILING_DATA_FIELD_DEF(uint32_t, dsaHotTableWidth)
TILING_DATA_FIELD_DEF(uint32_t, dsaHostTableWidth)
TILING_DATA_FIELD_DEF(uint32_t, dsaHotPhysicalBlocks)
TILING_DATA_FIELD_DEF(uint32_t, dsaHostPhysicalBlocks)
TILING_DATA_FIELD_DEF(uint32_t, dsaHotPoolCapacity)
TILING_DATA_FIELD_DEF(uint32_t, dsaHostPoolCapacity)
END_TILING_DATA_DEF
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(FusedKvGatherSparseFlashAttention, SparseFlashAttentionTilingDataMla)
...
struct SFATilingInfo {
    ...
    bool isA5 = false;
    uint32_t dsaRouteWidth = 0;
    uint32_t dsaHotTableWidth = 0;
    uint32_t dsaHostTableWidth = 0;
    uint32_t dsaHotPhysicalBlocks = 0;
    uint32_t dsaHostPhysicalBlocks = 0;
    uint32_t dsaHotPoolCapacity = 0;
    uint32_t dsaHostPoolCapacity = 0;
    uint32_t bSize = 0;
    uint32_t n1Size = 0;
    uint32_t n2Size = 0;
    uint32_t s1Size = 0;
...
#endif // FUSED_KV_GATHER_SPARSE_FLASH_ATTENTION_TILING_H
