...
class DsaSparseTurboResolveUpdateBatchV2 : public OpDef {
public:
    explicit DsaSparseTurboResolveUpdateBatchV2(const char* name)
        : OpDef(name)
    {
...
OP_ADD(DsaSparseTurboResolveUpdateBatchV2);
}  // namespace ops
