...
#include "dsa_sparse_turbo_resolve_update_batch_v2_tiling.h"
...
namespace optiling {
static ge::graphStatus DsaSparseTurboResolveUpdateBatchV2Tiling(
    gert::TilingContext* context)
{
    ...
    auto* data = context->GetTilingData<
        DsaSparseTurboResolveUpdateBatchV2TilingData>();
...
static ge::graphStatus ParseDsaSparseTurboResolveUpdateBatchV2(
...
IMPL_OP_OPTILING(DsaSparseTurboResolveUpdateBatchV2)
    .Tiling(DsaSparseTurboResolveUpdateBatchV2Tiling)
    .TilingParse<DsaSparseTurboResolveUpdateBatchV2CompileInfo>(
        ParseDsaSparseTurboResolveUpdateBatchV2);
}  // namespace optiling
