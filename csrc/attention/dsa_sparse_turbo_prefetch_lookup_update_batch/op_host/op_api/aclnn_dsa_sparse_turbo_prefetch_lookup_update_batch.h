...
#ifndef ACLNN_DSA_SPARSE_LOOKUP_UPDATE_TURBO_PREFETCH_H
#define ACLNN_DSA_SPARSE_LOOKUP_UPDATE_TURBO_PREFETCH_H
...
aclnnDsaSparseTurboPrefetchLookupUpdateBatchGetWorkspaceSize(
...
#endif  // ACLNN_DSA_SPARSE_LOOKUP_UPDATE_TURBO_PREFETCH_H
