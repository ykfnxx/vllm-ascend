...
#include "dsa_sparse_turbo_prefetch_lookup_update_batch_tiling.h"
...
static ge::graphStatus DsaSparseTurboPrefetchLookupUpdateBatchTilingFunc(
    gert::TilingContext* context)
{
    if (context == nullptr) {
    ...
    auto* tiling_data =
        context->GetTilingData<DsaSparseTurboPrefetchLookupUpdateBatchTilingData>();
...
static ge::graphStatus TilingParseForDsaSparseTurboPrefetchLookupUpdateBatch(
...
IMPL_OP_OPTILING(DsaSparseTurboPrefetchLookupUpdateBatch)
    .Tiling(DsaSparseTurboPrefetchLookupUpdateBatchTilingFunc)
    .TilingParse<DsaSparseTurboPrefetchLookupUpdateBatchCompileInfo>(
        TilingParseForDsaSparseTurboPrefetchLookupUpdateBatch);
