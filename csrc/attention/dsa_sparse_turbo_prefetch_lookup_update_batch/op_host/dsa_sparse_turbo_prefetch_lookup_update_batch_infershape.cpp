...
static ge::graphStatus InferShapeForDsaSparseTurboPrefetchLookupUpdateBatch(
...
static ge::graphStatus InferDataTypeForDsaSparseTurboPrefetchLookupUpdateBatch(
...
IMPL_OP_INFERSHAPE(DsaSparseTurboPrefetchLookupUpdateBatch)
    .InferShape(InferShapeForDsaSparseTurboPrefetchLookupUpdateBatch)
    .InferDataType(InferDataTypeForDsaSparseTurboPrefetchLookupUpdateBatch);
