...
class DsaSparseTurboPrefetchLookupUpdateBatch : public OpDef {
public:
    explicit DsaSparseTurboPrefetchLookupUpdateBatch(const char* name) : OpDef(name)
    {
...
OP_ADD(DsaSparseTurboPrefetchLookupUpdateBatch);
