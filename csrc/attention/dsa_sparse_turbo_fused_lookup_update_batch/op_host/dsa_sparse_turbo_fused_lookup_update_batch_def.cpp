...
class DsaSparseTurboFusedLookupUpdateBatch : public OpDef {
public:
    explicit DsaSparseTurboFusedLookupUpdateBatch(const char* name) : OpDef(name)
    {
        ...
        this->Attr("is_mtp").AttrType(REQUIRED).Int();

        this->AICore().AddConfig("ascend950");
    }
};

OP_ADD(DsaSparseTurboFusedLookupUpdateBatch);
