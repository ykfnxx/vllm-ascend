...
#ifndef DSA_SPARSE_LOOKUP_UPDATE_TURBO_FUSED_COMMON_H
#define DSA_SPARSE_LOOKUP_UPDATE_TURBO_FUSED_COMMON_H
...
// turbo scalars (8) plus per-request verify/tail start values, computed once
// per request and consumed by every query's classification.
