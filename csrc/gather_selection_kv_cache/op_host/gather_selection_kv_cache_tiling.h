...
TILING_DATA_FIELD_DEF(int64_t, attentionIndicesWidth);
TILING_DATA_FIELD_DEF(int64_t, queryPositionWidth);
END_TILING_DATA_DEF;
...
public:
    explicit GatherSelectionKvCacheTiling(gert::TilingContext* context)
        : context_(context)
    {}
